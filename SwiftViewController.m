...
@property (nonatomic, strong) AnimatedGifView *imageView1;
@property (nonatomic, strong) AnimatedGifView *imageView2;
@property (nonatomic, strong) AnimatedGifView *imageView3;
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    // 1
    if (!self.imageView1) {
        self.imageView1 = [[AnimatedGifView alloc] init];
    ...
    AnimatedGif *animatedImage1 = [[AnimatedGif alloc] initWithGifData:data1];
    self.imageView1.animatedGif = animatedImage1;
    
    // 2
    if (!self.imageView2) {
        self.imageView2 = [[AnimatedGifView alloc] init];
    ...
    AnimatedGif * __block animatedImage2 = nil;
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        NSURL *url2 = [NSURL URLWithString:@"http://raphaelschaad.com/static/nyan.gif"];
        NSData *data2 = [NSData dataWithContentsOfURL:url2];
        animatedImage2 = [[AnimatedGif alloc] initWithGifData:data2];
    ...
    // 3
    if (!self.imageView3) {
        self.imageView3 = [[AnimatedGifView alloc] init];
